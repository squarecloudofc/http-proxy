...
const extend = require("node:util")._extend
...
common.setupOutgoing = function (outgoing, options, req, forward) {
    ...
    if (options.changeOrigin) {
        outgoing.headers.host =
            isPortRequired(outgoing.port, options[forward || "target"].protocol) && !hasPort(outgoing.host) ? outgoing.host + ":" + outgoing.port : outgoing.host
    }
    return outgoing
}
